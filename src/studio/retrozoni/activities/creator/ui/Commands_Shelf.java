package studio.retrozoni.activities.creator.ui;
...
public class Commands_Shelf {
	...
	private class C {
		...
		private Font font = FontHandler.font("septem", 8*Engine.SCALE);
		...
		public void render(Graphics2D g) {
			if(Mouse.On_Mouse(bounds))
				g.setColor(new Color(Theme.Primary.getRed(), Theme.Primary.getGreen(), Theme.Primary.getBlue(), 100));
			else
