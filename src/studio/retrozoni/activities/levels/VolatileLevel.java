package studio.retrozoni.activities.levels;
...
class VolatileLevel {
	...
	public VolatileLevel(Level level) {
		...
		this.font = FontHandler.font("septem", 14*Engine.SCALE);
	...
	public int fontWidth() {
		return FontHandler.getWidth(Name, font);
	}
	
	public int fontHeight() {
		return FontHandler.getHeight(Name, font);
	}
